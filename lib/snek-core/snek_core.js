...
* @returns {string}
*/
export function python_to_html(code) {
    let deferred2_0;
    let deferred2_1;
    try {
        ...
        wasm.python_to_html(retptr, ptr0, len0);
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_now_16fd2f6131d0b052 = function() {
        const ret = Date.now();
        return ret;
    };
    imports.wbg.__wbg_error_f3cde794e118ca2e = function(arg0, arg1) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('snek_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
